...
resolution = [32, 32]			    # Resolution of reduced image
decision_input_size = 640
...
max_potential = 30.                 # Maximum feature potential
...
reward_factor = 0.02				# Reward factor modulating reward signal strength
...
# parameters to show
positions = []
weight_selected_sequence1 = []
weight_selected_sequence2 = []
weight_selected_sequence3 = []
